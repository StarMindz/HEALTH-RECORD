   ...
   <div className={style.main_text}>
    <div className={style.main_text_cont}>
     ...
     <p className={style.main_paragraph}>
      Experience a personalized healthcare experience tailored to your unique needs, all from the
      convenience of your mobile device.
      <br />
      <br />
      You can securely share your medical information with authorized parties, connect with
      healthcare professionals and fellow patients for support, and even order medications and
      supplements directly from the app.
     </p>
    </div>
   </div>

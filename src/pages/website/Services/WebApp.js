   ...
   <div className={style.main_text}>
    <div className={style.main_text_cont}>
     ...
     <p className={style.main_paragraph}>
      Our Intuitive webapp allows insurance companies to conveniently access transaction records for
      insured patients, promoting honesty and preventing fraud.
      <br />
      <br />
      It is the ultimate tool for insurers looking to gain a competitive edge in a rapidly changing
      market.
     </p>
    </div>
   </div>

    ...
    <div className={style.add_cont}>
     <div className={style.sub_cont}>
      ...
      <div className={style.input}>
       <Input type="text" label="Name of medication" placeholder="Medication" required />
       <Input type="text" label="Dosage" placeholder="Dosage" required />
       <Input type="date" label="Select Start Date" placeholder="08/17/2023" />
       <Input type="date" label="Select Due date" placeholder="08/17/2023" />
       <TextArea label="Reason for taking" placeholder="Reason for taking" />
      </div>
      <Button text="+ Add Medication" btnType={2} />
     </div>
    </div>
   </div>
  </div>

    ...
    <div className={style.add_cont}>
     <div className={style.sub_cont}>
      ...
      <div className={style.input}>
       <Input type="text" label="Description" placeholder="Transaction Description" required />
       <Input type="number" label="Transaction Amount" placeholder="Amount" required />
      </div>
      <Button text="+ Add Transaction" btnType={2} />
     </div>
    </div>
   </div>
  </div>

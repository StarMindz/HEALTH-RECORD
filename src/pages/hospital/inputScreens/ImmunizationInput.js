    ...
    <div className={style.add_cont}>
     <div className={style.sub_cont}>
      ...
      <div className={style.input}>
       <Input type="text" label="Name of Vaccine" placeholder="Vaccine" required />
       <Input type="text" label="Lot Number" placeholder="Vaccines batch number" />
       <Input type="date" label="Expiration Date" placeholder="Expiration date" />
       <TextArea label="More info" placeholder="Comments" />
      </div>
      <Button text="+ Add Immunization" btnType={2} />
     </div>
    </div>
   </div>
  </div>

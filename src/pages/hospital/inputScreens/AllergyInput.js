    ...
    <div className={style.add_cont}>
     <div className={style.sub_cont}>
      ...
      <div className={style.input}>
       <Input type="text" label="Name of Allergy" placeholder="Allergen" required />
       <Input2
        options={['Food', 'Drug', 'Environmental', 'Insect', 'Latex', 'Contact', 'Weather']}
        label="Allergy Type"
        required
       />
       <Input type="text" label="Reactions" placeholder="Allergy Reaction" />
       <TextArea label="More info" placeholder="Comments" />
      </div>
      <Button text="+ Add Allergy" btnType={2} />
     </div>
    </div>
   </div>
  </div>

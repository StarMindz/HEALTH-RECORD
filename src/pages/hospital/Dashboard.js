...
//  patientData.name = name;
 ...
 const html = (
  <div className={style.dashboard}>
   <div className={showDashboard ? style.main_cont : style.none}>
    <div className={style.side_bar}>
     ...
     <div className={style.menu_items}>
      <div
       className={`${style.side_bar_item} ${active === 'home' ? style.active : ''}`}
       role="button"
      ...
      <div
       className={`${style.side_bar_item} ${active === 'profile' ? style.active : ''}`}
       role="button"
      ...
      <div
       className={`${style.side_bar_item} ${active === 'medication' ? style.active : ''}`}
       role="button"
      ...
      <div
       className={`${style.side_bar_item} ${active === 'allergy' ? style.active : ''}`}
       role="button"
      ...
      <div
       className={`${style.side_bar_item} ${active === 'immunization' ? style.active : ''}`}
       role="button"
       onClick={() => handleClick('immunization')}
      >
       <img className={style.item_img} src={immunization} alt="immunization" />
       <h2 className={style.item_text}>Immunization</h2>
      </div>
      <div
       className={`${style.side_bar_item} ${active === 'test' ? style.active : ''}`}
       role="button"
      ...
      <div
       className={`${style.side_bar_item} ${active === 'transaction' ? style.active : ''}`}
       role="button"
   ...
   <div className={showInput ? style.inputModal : style.none}>{inputScreen[activeInput]}</div>
  </div>
 )

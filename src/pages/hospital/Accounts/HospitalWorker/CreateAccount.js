...
const HospitalWorkerEnrol = () => {
 ...
 const handleSubmit = (event) => {
  ...
  const { name, email, password1, password2, gender, dob, phone, address } = values
  ...
  <div className={style.main_cont}>
   <div className={style.left_cont}>
    <div className={style.background}>
     <p className={style.intro}>
      Get quick, secure access to your patients health records Enrol to provide the best possible
   ...
   <div className={style.right_cont}>
    <div className={style.form_cont}>
     <h1 className={style.heading}>Enrol Health worker</h1>
     <form className={style.form}>
      <Input type="text" label="Full Name" placeholder="Full Name" required />
      <Input
       type="email"
       label="Email Address"

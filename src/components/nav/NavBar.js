 ...
 const nav = (
  <div className={style.nav_bar}>
   ...
   <div className={`${style.nav_bar_menu} ${state.toggle ? '' : style.active}`}>
    <a onClick={handleClick} href="#home" className={style.menu_item}>
     Home
    </a>
    <a onClick={handleClick} href="#service" className={style.menu_item}>
     Services
    </a>
    <a onClick={handleClick} href="#contact" className={style.menu_item}>
     Contact us
    </a>
    <div className={style.nav_buttons}>
     <Link to="/signup">
      <Button text="Sign Up" btnType={4} />
     </Link>
     <Link to="/signin">
      <Button text="Log In" btnType={3} />
     </Link>
    </div>
   </div>
